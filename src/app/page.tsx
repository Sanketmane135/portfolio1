...
{/* ============ project ============== */}
          <section className="flex flex-col gap-8">
            ...
            <section className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-lg border border-gray-600  bg-card text-card-foreground shadow-sm flex flex-col  items-center gap-2  ">
                                         ...
                                         <div className=" w-full p-6 pt-0 flex h-full flex-col items-start justify-between gap-2 ">
                                           ...
                                           <div className="flex flex-row flex-wrap items-center gap-1">
                                             <a href="https://bagpacktrips.vercel.app/">
